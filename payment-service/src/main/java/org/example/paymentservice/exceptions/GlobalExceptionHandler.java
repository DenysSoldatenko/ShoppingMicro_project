...
/**
 * Global exception handler for PaymentService exceptions.
 */
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {

  /**
   * Handles custom exceptions from PaymentService.
   *
  ...
  public ResponseEntity<ErrorDetails> handleProductServiceCustomException(
      PaymentServiceException exception, WebRequest webRequest
  ) {
